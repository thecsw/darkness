...
func BuildGalleryFiles(conf *alpha.DarknessConfig, dryRun bool) {
	...
	// Get all the gallery files, some may need nested macros.
...
// TODO: Figure out what to do with this, since it's also in ichika/build.go
...
func recordGlobalMacros(conf *alpha.DarknessConfig) {
	...
	globalMacrosFile := yunyun.RelativePathFile("_macros" + conf.Project.Input)
